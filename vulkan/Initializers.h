...
inline VkImageSubresourceRange subResourceCreateInfo(){
    VkImageSubresourceRange subResourceInfo{};
    subResourceInfo.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
    subResourceInfo.baseMipLevel = 0;
    subResourceInfo.levelCount = 1;
    subResourceInfo.baseArrayLayer = 0;
    subResourceInfo.layerCount = 1;
